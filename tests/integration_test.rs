...
async fn test_python_only_config() {
    ...
    assert!(
        !config.rust_enabled,
        "Python-only config should disable Rust tools"
    );
    assert!(
        config.python_enabled,
        "Python-only config should enable Python tools"
    );
    assert!(
        !config.node_enabled,
        "Python-only config should disable Node tools"
    );
    assert!(
        !config.cache_enabled,
        "Python-only config should disable cache tools"
    );
}
...
async fn test_rust_only_config() {
    ...
    assert!(
        config.rust_enabled,
        "Rust-only config should enable Rust tools"
    );
    assert!(
        !config.python_enabled,
        "Rust-only config should disable Python tools"
    );
    assert!(
        !config.node_enabled,
        "Rust-only config should disable Node tools"
    );
    assert!(
        !config.cache_enabled,
        "Rust-only config should disable cache tools"
    );
}
...
async fn test_node_only_config() {
    ...
    assert!(
        !config.rust_enabled,
        "Node-only config should disable Rust tools"
    );
    assert!(
        !config.python_enabled,
        "Node-only config should disable Python tools"
    );
    assert!(
        config.node_enabled,
        "Node-only config should enable Node tools"
    );
    assert!(
        !config.cache_enabled,
        "Node-only config should disable cache tools"
    );
}
...
async fn test_all_config() {
    ...
    assert!(
        config.python_enabled,
        "All config should enable Python tools"
    );
